...
import { ButtonPengaturan } from "../../karyawan/Pengaturan/ButtonPengaturan";
import { User, LogOut, HelpCircle, Info, Settings } from "lucide-react-native";
    ...
    return (
        <ScrollView className="flex-1 bg-[#F9FAFB]">
            ...
            <View className="flex-row items-center p-4 mx-4 -mt-4 bg-white rounded-xl"
                ...
                <View className="ml-3">
                    ...
                    <View className="flex-row items-center mt-1">
                        ...
                        <Text className="text-xs text-gray-500">Status Aktif</Text>
                    </View>
                </View>
            </View>
            ...
            <View className="px-4 mt-6">
                ...
                <ButtonPengaturan 
                    title="Atur Ruang"
                    text="Atur ruang anda"
                    icon={<Settings size={18} color="#00BFA6" strokeWidth={2} />}
                    colorBgIcon="rgba(0,191,166,0.15)"
                    onPress={() => navigation.navigate('AturRuangScreen' as never)}
                />
            </View>
