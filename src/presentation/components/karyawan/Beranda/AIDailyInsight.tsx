    ...
    return (
        ...
        >
            <View className="flex flex-row items-center">
                ...
                <Text className="text-[18px] font-bold text-[#111827] ml-2" numberOfLines={1} ellipsizeMode="tail">{title}</Text>
            </View>
            
            <View className="bg-[#FFFFFF]/60 mt-4 rounded-3xl p-4">
                {loading ? (
                  <Text className="text-[#6B7280] ml-2" numberOfLines={3} ellipsizeMode="tail">
                    Memuat insight dari AI...
                  </Text>
                ) : (
                  <Text className="text-[#6B7280] ml-2" numberOfLines={4} ellipsizeMode="tail">
